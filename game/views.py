...
class SessionAdminViewSet(ModelViewSet):
	...
	@action(methods=['GET'], detail=True, url_path='start-session')
	...
	@action(methods=['PUT'], detail=True, url_path='set-turn-phase')
	...
	@action(methods=['PUT'], detail=True, renderer_classes=[JSONRenderer], url_path='count-session')
